...
<div class="container my-5">
  <div class="row">
  <?php
//getten gelen category parametresi atandıysa al değişkene at.
    if(isset($_GET['category'])){
      $products_kategori_selected=$_GET['category'];
    }

      $sql="SELECT * FROM ürünler WHERE products_kategori='$products_kategori_selected'";//hangi kategoriye tıklandıysa ürünler tablosundan onu al
    ...
    <div class="col-md-12 col-lg-2 p-4">
      ...
      <form method="POST" action="sepet.php?action=add&products_id=<?php echo $row["products_id"]; ?>"> 
        ...
        <p class="text-center" style="font-weight:bold;"><?php echo $row["products_fiyat"]; ?>TL</p>  
