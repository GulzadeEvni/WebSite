    ...
    <!-- Sidebar -->
      ...
      <div id="content-wrapper">
        ...
        if(isset($_POST['add_post'])){
            $yazar_isim= $_POST['post_title'];
            $yazar_img= $_POST['post_image'];


            if($yazar_isim  == "" || empty($yazar_isim)){
                echo "<div class='alert alert-danger' role='alert'>
                Bu Alan Boş Bırakılamaz!
              </div>";
            }
            else{
                $sql_query = "INSERT INTO yazarlar(yazar_isim,yazar_img) VALUES('".$yazar_id."','".$yazar_isim."','".$yazar_img."')";
                $add_new_yaz_query = mysqli_query($db,$sql_query);
            }
...
<?php 
            ...
            $sql_query="SELECT * FROM yazarlar";
            $select_yazarlar=mysqli_query($db,$sql_query);
                while($row= mysqli_fetch_assoc($select_yazarlar)){
            ...
            ?>
                    ...
                    <tr>
                        <td><?php echo $row['yazar_id']; ?></td>
                        <td><?php echo $row['yazar_img']; ?></td>
                        <td><?php echo $row['yazar_isim']; ?></td>
                        <td>
                            <div class='dropdown'>
                        ...
                        <div class="modal-body">
                            <form action="" method="post">
                                <div class="form-group">
                                    <label for="post_title">yazar_isim</label>
